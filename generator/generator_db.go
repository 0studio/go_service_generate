...
func (sd StructDescription) GenerateDBStorage(property Property, srcDir string) {
	...
	outputF.WriteString(" // do not edit this file ,this is generated by tools(https://github.com/0studio/go_service_generator)\n\n")
	outputF.WriteString("import (\n")
	outputF.WriteString("    \"database/sql\"\n")
	outputF.WriteString("    \"fmt\"\n")
	outputF.WriteString("    \"time\"\n")
	outputF.WriteString("    \"github.com/0studio/databasetemplate\"\n")
	outputF.WriteString("    key \"github.com/0studio/storage_key\"\n")
	outputF.WriteString("    \"github.com/0studio/logger\"\n")

	outputF.WriteString(")\n\n")
	outputF.WriteString("var ___importTimeDB time.Time\n\n")
	outputF.WriteString("var ___importKeyDB key.KeyUint64\n\n")
	outputF.WriteString("var __importFMTDB func(a ...interface{}) (n int, err error) = fmt.Println\n\n")
	outputF.WriteString(sd.GenerateDBStorageStruct())
	outputF.WriteString(sd.GenerateNewDBStorageStruct())
	outputF.WriteString(sd.GenerateDBCreateTable())
	outputF.WriteString(sd.GenerateDBMapRow())
	outputF.WriteString(sd.GenerateDBGet())
	outputF.WriteString(sd.GenerateDBAdd())
	outputF.WriteString(sd.GenerateDBMultiAdd())
	outputF.WriteString(sd.GenerateDBSet())
	outputF.WriteString(sd.GenerateDBMultGet())
	outputF.WriteString(sd.GenerateDBMultUpdate())
